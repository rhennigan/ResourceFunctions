(* !Excluded
This notebook was automatically generated from [Definitions/AIAssistant](https://github.com/rhennigan/ResourceFunctions/blob/main/Definitions/AIAssistant).
*)
...
$icons = IconizeInPlace[
    $icons = Association @ Map[
...
executeAIAssistantCommand[ "Loaded"         , args___ ] := $aiAssistantLoaded;
...
$thisResourceInfo := With[ { name = Context @ AIAssistant <> "AIAssistant" },
    FirstCase[
